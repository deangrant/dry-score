//! Shared structural emit helpers used by expr and pattern emitters.

use syn::{Block, Expr, Member, RangeLimits};
...
pub(super) fn emit_optional_inner(
    label: &'static str,
    inner: Option<&Expr>,
...
pub(super) fn emit_labeled_block(
    label: &'static str,
    block: &Block,
    placeholders: &mut PlaceholderMap,
) -> NormNode {
